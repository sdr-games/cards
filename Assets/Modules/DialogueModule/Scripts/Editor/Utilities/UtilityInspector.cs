...
{
    public static class UtilityInspector
    {
        ...
        public static float DrawRangeField(this SerializedProperty serializedProperty)
        {
            return EditorGUILayout.Slider(serializedProperty.displayName, serializedProperty.floatValue, 0, 100);
        }
