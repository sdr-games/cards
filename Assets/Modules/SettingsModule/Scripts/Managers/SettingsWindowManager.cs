...
namespace SDRGames.Whist.SettingsModule.Managers
{
    public class SettingsWindowManager : MonoBehaviour
    {
        ...
        [SerializeField] private TabButtonsManager _tabButtonsManager;
        ...
        private void OnEnable()
        {
            ...
            if (_tabButtonsManager == null)
            {
                Debug.LogError("Tab Buttons Manager не был назначен");
                #if UNITY_EDITOR
                    EditorApplication.isPlaying = false;
                #endif
                Application.Quit();
